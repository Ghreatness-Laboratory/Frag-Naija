...
ALTER TABLE athletes ADD COLUMN IF NOT EXISTS chess_rating INTEGER;
ALTER TABLE athletes ADD COLUMN IF NOT EXISTS chess_title TEXT;
ALTER TABLE athletes ADD COLUMN IF NOT EXISTS chess_peak_rating INTEGER;
ALTER TABLE athletes ADD COLUMN IF NOT EXISTS chess_wins INTEGER NOT NULL DEFAULT 0;
ALTER TABLE athletes ADD COLUMN IF NOT EXISTS chess_draws INTEGER NOT NULL DEFAULT 0;
ALTER TABLE athletes ADD COLUMN IF NOT EXISTS chess_losses INTEGER NOT NULL DEFAULT 0;
ALTER TABLE athletes ADD COLUMN IF NOT EXISTS federation TEXT;
