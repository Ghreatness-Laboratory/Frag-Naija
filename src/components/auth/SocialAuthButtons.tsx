    ...
    <div className="space-y-2.5">
      {providers.map(({ provider, label, className, icon }) => (
        <button
          ...
          className={`flex w-full items-center justify-center gap-3 rounded py-2.5 text-sm font-bold transition-all disabled:cursor-not-allowed disabled:opacity-50 ${className}`}
        >
          {icon}
