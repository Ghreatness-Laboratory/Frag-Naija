          ...
          >
            ...
            <div className="grid gap-1.5">
              ...
              <Link href="/custom-wager" className="flex items-center justify-between rounded-sm border border-fn-green/30 bg-fn-green/10 px-3 py-2.5 text-[10px] font-bold uppercase tracking-widest text-fn-green hover:bg-fn-green/20">
                <span className="flex items-center gap-2"><Swords size={12} /> Custom Wager</span><ChevronRight size={12} />
              </Link>
              ...
              <Link href="/settings" className="flex items-center justify-between rounded-sm border border-fn-green/30 bg-fn-green/10 px-3 py-2.5 text-[10px] font-bold uppercase tracking-widest text-fn-green hover:bg-fn-green/20">
                <span className="flex items-center gap-2"><Settings size={12} /> Settings</span><ChevronRight size={12} />
              </Link>
