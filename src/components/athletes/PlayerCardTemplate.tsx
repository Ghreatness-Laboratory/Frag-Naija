...
export default function PlayerCardTemplate({
  ...
  if (variant === 'compact') {
    return (
      <div className={cx('player-card player-card-compact relative h-[118px] w-full overflow-hidden rounded-sm border border-fn-gborder bg-fn-card text-white', className)} style={{ backgroundImage: 'none' }}>
