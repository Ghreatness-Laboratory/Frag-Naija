  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const body = {
        ...
        ...(chessGame ? {
          chess_rating: Number(form.chess_rating),
          chess_title: form.chess_title,
          chess_peak_rating: form.chess_peak_rating ? Number(form.chess_peak_rating) : null,
          chess_wins: form.chess_wins ? Number(form.chess_wins) : 0,
          chess_draws: form.chess_draws ? Number(form.chess_draws) : 0,
          chess_losses: form.chess_losses ? Number(form.chess_losses) : 0,
