...
export async function GET(request) {
  try {
    ...
    return NextResponse.json({ alerts, notifications, unreadCount, tournaments: tournaments.filter((t) => ['live', 'upcoming', 'completed'].includes(String(t.display_status || t.status).toLowerCase())), matches: tracker.matches });
  } catch (e) {
