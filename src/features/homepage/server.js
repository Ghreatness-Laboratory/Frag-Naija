...
export const DEFAULT_HOMEPAGE_SETTINGS = {
  ...
  popup_enabled: 'false', popup_image_url: '',
  // The admin form writes popup_title and popup_cta. The similarly named
  // popup_headline and popup_cta_label columns are retained for legacy rows.
  popup_title: '', popup_body: '', popup_cta: '', popup_cta_link: '',
